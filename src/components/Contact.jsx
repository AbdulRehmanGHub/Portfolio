...
const Contact = () => {
    return (
        <div name="contact" className="w-full h-fit bg-gradient-to-b from-black to-gray-800 p-4 text-white cursor-default">
            <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full pt-20">
                ...
                <div className="flex justify-center items-center">
                    <form action="https://getform.io/f/c47667af-7bf7-4dc5-b38b-52d06187fbc6" method="POST" className="flex flex-col w-full md:w-1/2 ">
